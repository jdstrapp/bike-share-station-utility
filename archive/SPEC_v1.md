...
Status: **Archived — v1, as deployed to production 2026-07-28.** This is
a frozen snapshot for reference. The live working document is the
top-level `SPEC.md`, which is now evolving into v2. Do not edit this file.
